...
export const Nav = () => {
  ...
  //
  return (
    <nav className="fixed top-0 w-full max-w-5xl bg-white/60 backdrop-blur-md px-5 py-3 flex justify-between xs:justify-start items-center gap-2 sm:gap-5">
      ...
      <AnimePresence>
        {showNav && (
          ...
          bg-slate-300/60 backdrop-blur-lg w-[50%] h-[200px] justify-center right-0 items-center gap-6 z-[90]"
          >
            <Link href="/">Home</Link>
            <Link href="/about">About</Link>
            <Link
